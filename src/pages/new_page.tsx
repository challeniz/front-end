...
import { FormButton, FormCancelButton, FormSubmitButton } from '../components/form_button';
  ...
  return (
    <Wrapper>
      ...
      <WhiteBox>
        ...
        <WhiteBoxContents>
            <p>회사는 개설챌린지의 주제를 검토할 수 있으며, 회사의 판단하에 챌린지를 삭제할 수 있습니다. 삭제할 수 있는 경우는 아래와 같습니다.</p>
              <StyledUl>
            ...
            <p>챌린지를 삭제할 때, 부적절한 챌린지로 판단되는 경우 서비스 이용을 영구정지 할 수 있습니다.</p>
            <AgreeBox>
              <p className="agree-title">약관동의</p>
              <input type="checkbox"></input>
              <p className="agree-text">위의 내용을 모두 읽어보았으며, 이에 모두 동의합니다.</p>
            </AgreeBox>
        </WhiteBoxContents>
      </WhiteBox>
      <FormButton>
